...
app.get("/posts/:id", function(req,res){
  ...
  let postById = posts.find(function(post){
    return post.id === id
  })
...
app.patch("/posts/:id", function(req,res){
  ...
  let findPost = posts.find(function(post){
    return post.id === id
  })
  ...
  let findPostIndex = posts.findIndex(function(post){
    return post.id === id
  })
...
app.delete("/posts/:id", function(req,res){
  ...
  let deletePost = posts.findIndex(function(post){
    return post.id === id
  })
